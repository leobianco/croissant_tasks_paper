...
- **Parent commit**: `02b87497` ("add - ct2code skill + updated pdf2ct skill") — same as previous run; upstream/mmlu_example has not advanced.
...
| Bug | Where | pyshacl error | Affects (this run) | Matches RISEBench analysis | Also fails on testdata |
|---|---|---|---|---|---|
